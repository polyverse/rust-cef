        ...
        .map(|attr| {
            let (usage_message, value_type, optional) = match attr.path.get_ident() {
                ...
                Some(ident) => match ident.to_string().as_str() {
                    ...
                    _ => return Err(SynError::new(attr.span(), format!("attribute ident not understood, and the internal filter should have protected you from it. This is a bug in rust-cef-derive crate.")).to_compile_error()),
                }
            };
